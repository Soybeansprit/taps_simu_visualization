...
namespace AnimGenerator
{
    ...
    public class Interpreter : MonoBehaviour
    {
        ...
        /// </summary>
        /// 打包时路径
        // private string JSON_FILE_NAME = Application.dataPath + "/Resources" + "/keyFrames.json";
        /// 放入Unity开发时使用
        // private string JSON_FILE_NAME = "Assets/JsonFile/keyFrames.json";
        // 在java中使用的路径
        private string JSON_FILE_NAME = "C:/Users/Administrator/Desktop/Project/Grade1/smarthome/newsmarthome210826/smarthome/src/main/resources/static/keyFrames.json"; 
        /// <summary>
        ...
        [Header("智能家电")]
        public GameObject Light;  // 灯
        public GameObject Curtain;  // 人
        public GameObject TV; // 电视
        public GameObject AirConditioner; // 空调
        ...
        {
            // 解析 json 文件并排序
            FileStream jsonfile = File.OpenRead(JSON_FILE_NAME);
        ...
        private void Appear(KeyFrame frame)
        {
            ...
            // 实例化物体
            GameObject tobeinstantiate = TV;
            switch (frame.type)
            {
                case 0:
                    tobeinstantiate = Light;
                    break;
                case 1:
                    tobeinstantiate = Curtain;
                    break;
                case 2:
                    tobeinstantiate = AirConditioner;
                    break;
                case 3:
                    tobeinstantiate = TV;
                    break;
                case 4:
                    tobeinstantiate = NextPos;
                    break;
                default:
        ...
        private const bool IS_3D_MODE = true;
        private IEnumerator Animate(KeyFrame frame)
        {
            ...
            if (IS_3D_MODE)
            {
                ...
                animator.SetTrigger(frame.animation);
                if(frame.name == "position")
                {
                    GameObject.Find("Target").transform.position = frame.StartPosition;
                }
            }
            else
            {
