...
public class TV {
    ...
    //起始位置
    private List<Double> startpos = new ArrayList<>(Arrays.asList(-24.28, 5.76, -18.85));
    private List<Double> endpos = new ArrayList<>(Arrays.asList(-24.28, 5.76, -18.85));
    //旋转角度
    ...
    //大小
    private List<Integer> startscale = new ArrayList<>(Arrays.asList(5, 5, 5));
    private List<Integer> endscale = new ArrayList<>(Arrays.asList(5, 5, 5));
    //持续时间
    private float duration = 0;
    //动画
    private String animation = "TVOFF";
    //循环时间
    private Integer loop = 0;


    public TV(Integer action, String name, float timestamp, String animation) {
        this.action = action;
        this.name = name;
    ...
    public TV(String name, float timestamp, String animation) {
        this.name = name;
        this.timestamp = timestamp;
        this.animation = animation;
    }

    public TV(Integer action, String name, float timestamp, List<Double> startpos, List<Double> endpos, String animation) {
        this.action = action;
        this.name = name;
        this.timestamp = timestamp;
    ...
    public TV(String name, float timestamp, List<Double> startpos, List<Double> endpos, String animation) {
        this.name = name;
        this.timestamp = timestamp;
        this.startpos = startpos;
        this.endpos = endpos;
