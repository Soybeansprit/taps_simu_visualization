...
public class Light {
    ...
    //起始位置
    private List<Double> startpos = new ArrayList<>(Arrays.asList(0.0, 12.0, -3.95));
    private List<Double> endpos = new ArrayList<>(Arrays.asList(0.0, 12.0, -3.95));
    //旋转角度
    ...
    //动画
    private String animation = "LightOn";
    //循环时间
    private Integer loop = 0;

    public Light(Integer action, String name, float timestamp, String animation) {
        this.action = action;
        this.name = name;
    ...
    public Light(String name, float timestamp, String animation) {
        this.name = name;
        this.timestamp = timestamp;
        this.animation = animation;
    }

    public Light(Integer action, String name, float timestamp, List<Double> startpos, List<Double> endpos, String animation) {
        this.action = action;
        this.name = name;
        this.timestamp = timestamp;
    ...
    public Light(String name, float timestamp, List<Double> startpos, List<Double> endpos, String animation) {
        this.name = name;
        this.timestamp = timestamp;
        this.startpos = startpos;
        this.endpos = endpos;
